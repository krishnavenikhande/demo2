...
$tb="insert into newform(name,branch,per,contact)values('$name','$branch',$per,'$contact')";
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputBranch3" placeholder="Branch" name="branch">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputper4">Percentage</label>
                        <input type="number" class="form-control" id="exampleInputper4" placeholder="Percentage" name="per">
                      </div>
                      <div class="form-group">
					   <label for="exampleInputContact">Contact</label>

                        <input type="number" class="form-control" id="exampleInputContact" placeholder="Conatct" name="contact">
