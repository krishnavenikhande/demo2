...
if(isset($_POST['btn']))
{
    ...
    $msg=$_POST['msg'];
 $tb="insert into textile(name,email,subject,msg)values('$name','$email','$subject','$msg')";
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-6 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>D-7/2, MIDC, Akkalkot Road, Solapur - 413 006, Maharashtra, India </p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 217 2656377 </p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@vishakatex.com</p>
