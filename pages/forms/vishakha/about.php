            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 ps-lg-0" style="min-height:200px;">
                    <div class="position-relative h-50">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/abouttowel.jpg" height="150" width="90" alt="" >
                    </div>
                </div>
                <div class="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <p class="mb-4 pb-2">TemporVishaka Industries Part of reputed business “kodam Group”, has grown manifold since its inception in the year 1968, having production capacity of 800 tons of Terry Towel & Toweling cloth annually.
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="text-center border border-5 border-light border-top-0 p-4" style='postion:relative;'>
                        <i class="fa fa-binoculars fa-lg" style='margin-left:20px;'alt=""></i>

                            <h5 class="mb-0">Our Vision</h5>
                            <small>Lorem Ipsum is simply dummy text of the printing and typesetting industry typesetting industry. Lorem Ipsum is simply dummy text of the printing and typesetting industry typesetting industry.</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        ...
                        <i class="fa fa-bullseye fa-lg" style='margin-left:20px;'alt=""></i>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="overflow-hidden position-relative">
                        ...
                        <div class="text-center border border-5 border-light border-top-0 p-4">
                        <i class="fa fa-check-square fa-lg" style='margin-left:20px;'alt=""></i>
