                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s" >
                    <div class="service-item">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="../img/<?php echo $rw[9]?>" style="width:400px;height:180px;">
                        </div>
                        <div class="p-4 text-center border border-5 border-light border-top-0">
                            <h4 class="mb-3"><?php echo $rw[8]?></h4>
                            <a class="fw-medium" href="product.php?id=<?php echo $rw[0]?>">Read More<i class="fa fa-arrow-right ms-2"></i></a>
                        </div>
                    </div>
