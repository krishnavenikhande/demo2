...
$tb="insert into product(title,material,quality,uses,sizes,gms,colors,imgname,img)values('$title','$material','$quality','$uses','$sizes','$gms','$colors','$imgname','$filename')";
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="exampleInputmaterials3">Materials</label>
                        <input type="text" class="form-control" id="exampleInputmaterials3" placeholder="material" name="material">
                      </div>
                      <div class="form-group">
                        <label for="examplequality4">Quality</label>
                        <input type="text" class="form-control" id="exampleInputquality4" placeholder="quality" name="quality">
                      </div>
                      <div class="form-group">
					   <label for="exampleInputuses5">Uses</label>
                        <input type="text" class="form-control" id="exampleInputuses5" placeholder="uses" name="uses">                   
                      </div>
                      <div class="form-group">
                        <label for="exampleInputsizes6">Sizes</label>
                        <input type="text" class="form-control" id="exampleInputsizes6" placeholder="sizes" name="sizes">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputgms7">GMS</label>
                        <input type="text" class="form-control" id="exampleInputgms7" placeholder="gms" name="gms">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputcolors">colors</label>
                        <input type="text" class="form-control" id="exampleInputcolors" placeholder="colors" name="colors">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputimgname">Imgname</label>
                        <input type="text" class="form-control" id="exampleInputimgname" placeholder="img name" name="imgname">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputimage">Image</label>
                        <input type="file" class="form-control" id="exampleInputimage" placeholder="img" name="image">
                      </div>
